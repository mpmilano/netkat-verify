...
(* OASIS_START *)
(* DO NOT EDIT (digest: 78e63e18bd3a3a7aacbf5b2e4611471e) *)
(*
...
(* # 21 "/var/tmp/portage/dev-ml/oasis-0.3.0/work/oasis-0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Verify_Dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "verify_lib";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Verify.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "d\251E\208\143f\188|\178J\tI\233\251c$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
