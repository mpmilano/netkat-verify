...
TEST "neg has no effect" = 
	...
	let topo = make_nolink_transition (1,1) (2,1) in
  ...
  verify  "narrowing down2"
    ...
    (starify 
	  ...
	  [(make_nolink_transition (1, 1) (2, 2)); 
	   (make_nolink_transition (2, 2) (3, 3))]
       ))
    (make_packet_2 3 3)
    false
...
let pol_topo_z3 = starify pol topo_z3
  ...
  (verify "why isn't this over-constraining?"
    ...
    TEST "why isn't this over-constraining?-z3" = 
	  (check_reachability_z3
		 "why isn't this over-constraining?-z3"
     (make_packet_2 1 1)
     (make_simple_topology
	(combine_topologies 
	   [(make_transition (1, 1) (2, 2));
...
(*
  ...
  (fun () -> (* anonymous namespace, the only way I know how *)
   let tran1 = make_nolink_transition (1, 1) (2 , 1) in
   let tran2 = make_nolink_transition (2, 1) (3, 1) in
   let tran3 = make_nolink_transition (1, 1) (4, 1) in
   let tran4 = make_nolink_transition (4, 1) (3, 1) in
...
[
(make_nolink_transition (0,0) (1,1))
])
...
;(make_nolink_transition (1,1) (2,2))
;(make_nolink_transition (2,2) (3,3))
;(make_nolink_transition (3,3) (4,4))
;(make_nolink_transition (4,4) (5,5))
])
...
;(make_nolink_transition (3,3) (4,4))
;(make_nolink_transition (4,4) (5,5))
;(make_nolink_transition (5,5) (6,6))
;(make_nolink_transition (6,6) (7,7))
;(make_nolink_transition (7,7) (8,8))
;(make_nolink_transition (8,8) (9,9))
;(make_nolink_transition (9,9) (10,10))
])
...
;(make_nolink_transition (8,8) (9,9))
;(make_nolink_transition (9,9) (10,10))
;(make_nolink_transition (10,10) (11,11))
;(make_nolink_transition (11,11) (12,12))
;(make_nolink_transition (12,12) (13,13))
;(make_nolink_transition (13,13) (14,14))
;(make_nolink_transition (14,14) (15,15))
;(make_nolink_transition (15,15) (16,16))
;(make_nolink_transition (16,16) (17,17))
;(make_nolink_transition (17,17) (18,18))
;(make_nolink_transition (18,18) (19,19))
;(make_nolink_transition (19,19) (20,20))
])
...
;(make_nolink_transition (18,18) (19,19))
;(make_nolink_transition (19,19) (20,20))
;(make_nolink_transition (20,20) (21,21))
;(make_nolink_transition (21,21) (22,22))
;(make_nolink_transition (22,22) (23,23))
;(make_nolink_transition (23,23) (24,24))
;(make_nolink_transition (24,24) (25,25))
;(make_nolink_transition (25,25) (26,26))
;(make_nolink_transition (26,26) (27,27))
;(make_nolink_transition (27,27) (28,28))
;(make_nolink_transition (28,28) (29,29))
;(make_nolink_transition (29,29) (30,30))
])
...
;(make_nolink_transition (28,28) (29,29))
;(make_nolink_transition (29,29) (30,30))
;(make_nolink_transition (30,30) (31,31))
;(make_nolink_transition (31,31) (32,32))
;(make_nolink_transition (32,32) (33,33))
;(make_nolink_transition (33,33) (34,34))
;(make_nolink_transition (34,34) (35,35))
;(make_nolink_transition (35,35) (36,36))
;(make_nolink_transition (36,36) (37,37))
;(make_nolink_transition (37,37) (38,38))
;(make_nolink_transition (38,38) (39,39))
;(make_nolink_transition (39,39) (40,40))
])
...
;(make_nolink_transition (38,38) (39,39))
;(make_nolink_transition (39,39) (40,40))
;(make_nolink_transition (40,40) (41,41))
;(make_nolink_transition (41,41) (42,42))
;(make_nolink_transition (42,42) (43,43))
;(make_nolink_transition (43,43) (44,44))
;(make_nolink_transition (44,44) (45,45))
;(make_nolink_transition (45,45) (46,46))
;(make_nolink_transition (46,46) (47,47))
;(make_nolink_transition (47,47) (48,48))
;(make_nolink_transition (48,48) (49,49))
;(make_nolink_transition (49,49) (50,50))
])
...
;(make_nolink_transition (48,48) (49,49))
;(make_nolink_transition (49,49) (50,50))
;(make_nolink_transition (50,50) (51,51))
;(make_nolink_transition (51,51) (52,52))
;(make_nolink_transition (52,52) (53,53))
;(make_nolink_transition (53,53) (54,54))
;(make_nolink_transition (54,54) (55,55))
;(make_nolink_transition (55,55) (56,56))
;(make_nolink_transition (56,56) (57,57))
;(make_nolink_transition (57,57) (58,58))
;(make_nolink_transition (58,58) (59,59))
;(make_nolink_transition (59,59) (60,60))
])
...
;(make_nolink_transition (58,58) (59,59))
;(make_nolink_transition (59,59) (60,60))
;(make_nolink_transition (60,60) (61,61))
;(make_nolink_transition (61,61) (62,62))
;(make_nolink_transition (62,62) (63,63))
;(make_nolink_transition (63,63) (64,64))
;(make_nolink_transition (64,64) (65,65))
;(make_nolink_transition (65,65) (66,66))
;(make_nolink_transition (66,66) (67,67))
;(make_nolink_transition (67,67) (68,68))
;(make_nolink_transition (68,68) (69,69))
;(make_nolink_transition (69,69) (70,70))
])
...
;(make_nolink_transition (68,68) (69,69))
;(make_nolink_transition (69,69) (70,70))
;(make_nolink_transition (70,70) (71,71))
;(make_nolink_transition (71,71) (72,72))
;(make_nolink_transition (72,72) (73,73))
;(make_nolink_transition (73,73) (74,74))
;(make_nolink_transition (74,74) (75,75))
;(make_nolink_transition (75,75) (76,76))
;(make_nolink_transition (76,76) (77,77))
;(make_nolink_transition (77,77) (78,78))
;(make_nolink_transition (78,78) (79,79))
;(make_nolink_transition (79,79) (80,80))
])
...
;(make_nolink_transition (78,78) (79,79))
;(make_nolink_transition (79,79) (80,80))
;(make_nolink_transition (80,80) (81,81))
;(make_nolink_transition (81,81) (82,82))
;(make_nolink_transition (82,82) (83,83))
;(make_nolink_transition (83,83) (84,84))
;(make_nolink_transition (84,84) (85,85))
;(make_nolink_transition (85,85) (86,86))
;(make_nolink_transition (86,86) (87,87))
;(make_nolink_transition (87,87) (88,88))
;(make_nolink_transition (88,88) (89,89))
;(make_nolink_transition (89,89) (90,90))
])
